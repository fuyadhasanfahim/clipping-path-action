...
import { FolderIcon, PhoneIcon, EnvelopeIcon } from "@heroicons/react/20/solid";
            ...
            <div className="mx-auto w-full max-w-7xl text-center">
                <div className="mx-auto w-full max-w-3xl text-center space-y-10">
                    ...
                    <p className="text-lg font-medium">
                        Thank you for visiting our website! You can let us know
                        if you need personalized help about anything. We will
                        get back to you as soon as possible!
                    </p>
                </div>
                <div className="grid grid-cols-3 gap-5 my-20">
                    <div className="w-full border-[1px] py-6 px-10 mx-auto text-center flex flex-col rounded-2xl shadow-xl bg-gray-100 bg-inherit z-10 hover:scale-105 duration-300 select-none cursor-pointer space-y-2">
                        <PhoneIcon className="text-orange-500 mx-auto bg-blue-50 w-20 p-6 rounded-full" />
                        <h2 className="text-xl font-semibold">Call Us Today</h2>
                        <p className="text-lg font-medium">+1 844-866-5577</p>
                    </div>
                    <div className="w-full border-[1px] py-6 px-10 mx-auto text-center flex flex-col rounded-2xl shadow-xl bg-gray-100 bg-inherit z-10 hover:scale-105 duration-300 select-none cursor-pointer space-y-2">
                        <EnvelopeIcon className="text-orange-500 mx-auto bg-blue-50 w-20 p-6 rounded-full" />
                        <h2 className="text-xl font-semibold">Call Us Today</h2>
                        <p className="text-lg font-medium">+1 844-866-5577</p>
                    </div>
                    <div className="w-full border-[1px] py-6 px-10 mx-auto text-center flex flex-col rounded-2xl shadow-xl bg-gray-100 bg-inherit z-10 hover:scale-105 duration-300 select-none cursor-pointer space-y-2">
                        <FolderIcon className="text-orange-500 mx-auto bg-blue-50 w-20 p-6 rounded-full" />
                        <h2 className="text-xl font-semibold">Call Us Today</h2>
                        <p className="text-lg font-medium">+1 844-866-5577</p>
                    </div>
                </div>
